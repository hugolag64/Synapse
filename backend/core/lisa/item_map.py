"""
backend/core/lisa/item_map.py
-------------------------------
Table officielle EDN 2026 : numéro d'item → titre canonique LiSA.
Source de vérité pour construire les URLs livret.uness.fr/lisa/2026/…

Usage :
    from backend.core.lisa.item_map import lisa_title, lisa_url
"""
...
# ── Table item_number → titre officiel LiSA ───────────────────────────────────

LISA_TITLES: dict[int, str] = {
    ...
    5: "Responsabilités médicale pénale, civile, administrative et disciplinaire. La gestion des erreurs et des plaintes ; l'aléa thérapeutique",
    ...
    55: "Développement psychomoteur du nourrisson et de l'enfant : aspects normaux et pathologiques (sommeil, alimentation, contrôles sphinctériens, psychomotricité, langage, intelligence). L'installation précoce de la relation parents-enfant et son importance. Troubles de l'apprentissage (voir item 122)",
    ...
    66: "Diagnostiquer : un trouble dépressif, un trouble anxieux, un trouble obsessionnel compulsif, un trouble de stress post-traumatique, un trouble de l'adaptation, un trouble de la personnalité",
    67: "Troubles du neurodéveloppement (voir items 55, 118, 121, 122, 138)",
    ...
    116: "Prurit",
    117: "Psoriasis",
    118: "La personne handicapée : bases de l'évaluation fonctionnelle et thérapeutique. (voir item 56)",
    ...
    124: "Ménopause, insuffisance ovarienne prématurée, andropause, déficit androgénique lié à l'âge. (Voir item 330)",
    ...
    135: "Thérapeutiques antalgiques, médicamenteuses et non médicamenteuses. (voir item 330)",
    ...
    184: "Accidents du travail et maladies professionnelles : définition et enjeux",
    ...
    201: "Transplantation d'organes : aspects épidémiologiques et immunologiques ; principes de traitement et surveillance ; complications et pronostic ; aspects éthiques et légaux. Prélèvements d'organes et législation",
    ...
    225: "Artériopathie de l'aorte, des artères viscérales et des membres inférieurs ; anévrysmes",
    ...
    246: "Gynécomastie",
    247: "Diabète sucré de type 1 et 2 de l'enfant et de l'adulte. Complications",
    ...
    325: "Identification et gestion des risques liés aux médicaments et aux biomatériaux, risque iatrogène, erreur médicamenteuse (voir items 4 et 5)",
    ...
    329: "Connaître les caractéristiques des produits sanguins labiles (PSL) et leur spécificité",
    ...
    332: "État de choc. Principales étiologies : hypovolémique, septique (voir item 158), cardio-génique, anaphylactique",
    333: "Situations exceptionnelles",
    334: "Prise en charge immédiate pré-hospitalière et à l'arrivée à l'hôpital, évaluation des complications chez : un brûlé, un polytraumatisé, un traumatisé thoracique, un traumatisé abdominal, un traumatisé des membres et/ou du bassin, un traumatisé du rachis ou vertébro-médullaire, un traumatisé crânien ou crânio-encéphalique",
    335: "Orientation diagnostique et conduite à tenir devant un traumatisme crânio-facial et oculaire",
    ...
    342: "Malaise, perte de connaissance, crise comitiale chez l'adulte (voir item 105)",
...
def lisa_title(item_number: str | int) -> str | None:
    """Retourne le titre officiel LiSA pour un numéro d'item, ou None."""
    try:
        return LISA_TITLES.get(int(item_number))
    except (ValueError, TypeError):
        return None


def lisa_url(item_number: str | int, fallback_title: str = "") -> str:
    """
    Construit l'URL LiSA depuis le numéro d'item (priorité) ou le titre fallback.
    Retourne "" si aucun des deux n'est disponible.
    """
    title = lisa_title(item_number) or fallback_title
    if not title:
        return ""
    slug = _url_quote(title.replace(" ", "_"), safe="_-()")
    return f"{_LISA_BASE}/{slug}"
