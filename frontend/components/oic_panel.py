...
.oic-row-code { flex:0 0 102px; font:10px var(--font-mono, ui-monospace); color:var(--text-dim); }
...
.oic-row-status { display:flex; align-items:center; gap:8px; flex:0 0 auto; }
